      ...
      <div className="hero-content">
        <motion.header className="hero-header" variants={itemVariants}>
          ...
          <p className="hero-subtitle">
            Transform your academic journey with our intelligent attendance
            tracking system. Stay on top of your attendance requirements with
            real-time insights and smart predictions.
          </p>
          <p className="copyright">
            © 2024 KLU Attendance Calculator | Crafted with ❤️ by Likith Kandepu
            (2200030837)
          </p>
        ...
        <motion.div className="notice-banner" variants={itemVariants}>
          ...
          <div className="notice-content">
            ...
            <p className="notice-text">
              Maintain a minimum of 75% attendance to ensure eligibility for
              examinations and not to get detained. Use our calculator to stay
        ...
        <motion.div className="features-grid" variants={itemVariants}>
          <div className="feature-card">
            ...
            <p className="feature-description">
              Calculate attendance across Lectures, Tutorials, Practicals, and
              Seminars with precision.
            </p>
            <Link to="/calbyltps" className="feature-button">
              Calculate Now
            </Link>
          </div>
          ...
          <div className="feature-card">
            ...
            <p className="feature-description">
              Get instant predictions on required classes to meet your target
              percentage.
            </p>
            <Link to="/total" className="feature-button">
              Plan Ahead
            </Link>
          </div>
          ...
          <div className="feature-card">
            ...
            <Link to="/calc3" className="feature-button">
              View Analytics
            </Link>
          </div>
        </motion.div>
        ...
        <motion.footer className="page-footer" variants={itemVariants}>
          <div className="footer-content">
            <div className="footer-section">
              ...
              <div className="footer-links">
                <Link to="/calbyltps" className="footer-link">
                  Calculator
                </Link>
                <Link to="/total" className="footer-link">
                  Statistics
                </Link>
                <Link to="/calc3" className="footer-link">
                  Analytics
                </Link>
              </div>
            </div>
          ...
          <div className="footer-bottom">
            <p className="copyright">
              © 2024 KLU Attendance Calculator | Crafted with ❤️ by Likith
              Kandepu (2200030837)
            </p>
          </div>
        </motion.footer>
